...
namespace BDFExport
{
 ...
 //          {
                ...
                Console.WriteLine("Exportando ventas...");
                GenerarExcelFacturacion(-1);
                Console.WriteLine("Exportando inventario...");
                ...
                Console.WriteLine("Enviando ventas...");
                EnviarExcelFacturacion();
                Console.WriteLine("Enviando inventario...");
                EnviarExcelInventario();
                Console.WriteLine("Enviando clientes...");
                EnviarExcelClientes();
            ...
            ActualizarFechaEnvio();
                ...
                Console.Write("Ejecutado correctamente");
       ...
       //     }
        ...
        private static void AvanzarNumeracion()
        {
            ...
            {
                Console.WriteLine("Ha ocurrido un error en la numeracion");
        ...
        static void LeerConfiguracionXML()
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.Write("Error en lectura de XML");
            }
        ...
        static void GenerarExcelInventario()
        {
            try
            {
                ...
                HojaExcel2.Range["B2"].Formula = "=COUNT(datos!e2:datos!e99999)";
                ...
                HojaExcel2.Range["B3"].Formula = "=SUM(datos!e2:datos!e99999)";
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("Error en generacion de inventario");
        ...
        static void GenerarExcelFacturacion()
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("Error en generacion de Ventas");
            }
        ...
        static void EnviarExcelClientes()
        {

            try
            {

                string fileToUpload = path + usuario + "_mc_" + DateTime.Today.AddDays(-1).ToString("yyyyMMdd") + ".xlsx";
                string url = url_clientes;
                using (var client = new WebClient())
                {
                    client.Headers.Add(HttpRequestHeader.Authorization, "Basic " + Convert.ToBase64String(System.Text.ASCIIEncoding.ASCII.GetBytes(usuario + ":" + contraseña)));
        ...
        static void GenerarExcelClientes(int vDias)
        {
            try
            {
                ...
                HojaExcel2.Range["A2:A2"].Value = "CantRegistros";
                //cuento la cantidad de registros
                HojaExcel2.Range["B2"].Formula = "=COUNT(datos!C2:datos!C99999)";
                int contar = Convert.ToInt32(HojaExcel2.Range["B2"].Value);
                HojaExcel2.Range["B2"].Value = contar;
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("Error en generacion de Clientes:" +ex.Message );
        ...
        static void GenerarExcelInventario(int vDias)
        {
            try
            {
                ...
                HojaExcel2.Range["A2:A2"].Value = "CantRegistros";
                //cuento la cantidad de registros
                HojaExcel2.Range["B2"].Formula = "=COUNT(datos!H2:datos!H99999)";
                int contar = Convert.ToInt32(HojaExcel2.Range["B2"].Value);
                HojaExcel2.Range["B2"].Value = contar;
                ...
                HojaExcel2.Range["A3:A3"].Value = "TotalUnidades";
                //sumo la columna cantidad
                HojaExcel2.Range["B3"].Formula = "=SUM(datos!H2:datos!H99999)";
                decimal sumar = Convert.ToDecimal(HojaExcel2.Range["B3"].Value);
                sumar = decimal.Round(sumar, 2);
                HojaExcel2.Range["B3"].Value = sumar;
        ...
        static void GenerarExcelFacturacion(int vDias)
        {
            try
            {
               ...
               // SelectString = SelectString + $"    v.fecha between '1/9/2023' and '30/9/2023' ";
                SelectString = SelectString + $"    v.fecha = Convert(varchar,DATEADD(d," + vDias.ToString() + ",getdate()),103) ";
                ...
                HojaExcel2.Range["A2:A2"].Value = "CantRegistros";
                //cuento la cantidad de registros
                HojaExcel2.Range["B2"].Formula = "=COUNT(datos!L2:datos!L99999)";
                int contar = Convert.ToInt32(HojaExcel2.Range["B2"].Value);
                HojaExcel2.Range["B2"].Value = contar;

                HojaExcel2.Range["A3:A3"].Value = "TotalUnidades";
                //sumo la columna cantidad
                HojaExcel2.Range["B3"].Formula = "=SUM(datos!L2:datos!L99999)";
                decimal sumar = Convert.ToDecimal(HojaExcel2.Range["B3"].Value);
                sumar = decimal.Round(sumar, 2);
                HojaExcel2.Range["B3"].Value = sumar;
                //guardo el documento
        ...
        static void LeerDatosConfiguracion()
        {
            try
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        ...
                        url_clientes = reader.GetString(10);
                ...
                {
                    Console.Write("El distribuidor no tiene seteado los datos de configuracion");
                }
                reader.Close();
                Conection.Close();
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("Error en leer configuracion");
            }
        ...
        static void CrearConfiguracionXML()
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("Error leyendo xml");
            }
